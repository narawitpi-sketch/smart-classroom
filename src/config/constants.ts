...
export const ADMIN_PASSWORD = 'smartclassroom@admin';
export const ALLOWED_ADMIN_EMAILS = ['narawit.pi@nsru.ac.th','nareupron.s@nsru.ac.th','phatchayan.t@nsru.ac.th','ratchadaporn.l@nsru.ac.th'];
